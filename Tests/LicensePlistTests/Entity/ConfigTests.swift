...
class ConfigTests: XCTestCase {
    ...
    func testInit_sample() throws {
        ...
        let configBasePath = url.deletingLastPathComponent()
        XCTAssertEqual(Config(yaml: try url.lp.download().resultSync().get(), configBasePath: configBasePath),
                       Config(githubs: [GitHub(name: "LicensePlist", nameSpecified: "License Plist", owner: "mono0926", version: "1.2.0"),
                              ...
                              options: GeneralOptions(outputPath: URL(fileURLWithPath: "./com.mono0926.LicensePlist.Output", relativeTo: configBasePath),
                                                      ...
                                                      xcworkspacePath: URL(fileURLWithPath: "*.xcworkspace", relativeTo: configBasePath),
                                                      xcodeprojPath: URL(fileURLWithPath: "*.xcodeproj", relativeTo: configBasePath),
