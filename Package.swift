...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/mono0926/LicensePlist/releases/download/3.26.0/LicensePlistBinary-macos.artifactbundle.zip",
            checksum: "d425bfa8c4a697c82d0c73c4a6a4b7a61bf95879bd8eeb6361adfa5f7695c094"
        )
    ]
)
