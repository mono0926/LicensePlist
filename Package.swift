...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/mono0926/LicensePlist/releases/download/3.24.8/LicensePlistBinary-macos.artifactbundle.zip",
            checksum: "10cf2c34f5fef9eed7b96d311654c463381a99eff4a9851088e48be7c0d522dd"
        )
    ]
)
