...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/mono0926/LicensePlist/releases/download/3.27.9/LicensePlistBinary-macos.artifactbundle.zip",
            checksum: "b3d121f3b247d3644341d4743f7fa862ffd1184928f60b24b1ff017d8f80f8aa"
        )
    ]
)
