...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/mono0926/LicensePlist/releases/download/3.27.6/LicensePlistBinary-macos.artifactbundle.zip",
            checksum: "84d338c6a5d14fd6909adc83ef1fa5e6f358e5311174cdca0a8f70add92cd31c"
        )
    ]
)
