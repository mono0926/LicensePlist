...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/mono0926/LicensePlist/releases/download/3.28.2/LicensePlistBinary-macos.artifactbundle.zip",
            checksum: "b7361afda76eaa56a71082a90462ee8493debd173914d80a3d34707415a544b7"
        )
    ]
)
