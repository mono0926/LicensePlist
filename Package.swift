...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/mono0926/LicensePlist/releases/download/3.28.1/LicensePlistBinary-macos.artifactbundle.zip",
            checksum: "136d1825ff7f8146a7cfe3b46b236eb8f138f2878272d48599c7c110f82acf5a"
        )
    ]
)
