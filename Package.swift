...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/mono0926/LicensePlist/releases/download/3.27.5/LicensePlistBinary-macos.artifactbundle.zip",
            checksum: "b68bf712f5ffbfeec2d12012f4fca2f01bcd4a06bef8a0f84d5caa7e108f93af"
        )
    ]
)
