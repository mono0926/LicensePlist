...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/mono0926/LicensePlist/releases/download/3.24.10/LicensePlistBinary-macos.artifactbundle.zip",
            checksum: "2994370faa0ddbd049963655ad3493c724ce3a6a1cece83b3463e6e0e41f1515"
        )
    ]
)
